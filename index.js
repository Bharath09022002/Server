...
mongoose.connect("mongodb+srv://bharath05:bharath05@bharath.7tqgc.mongodb.net/bank").then(console.log("MongoDB Connected"));
...
let Data=mongoose.model('Bank',newSchema)
app.listen(8080, function(){
    console.log('Server running atmongodb://localhost:27017/');
});